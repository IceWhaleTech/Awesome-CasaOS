import { _ as _export_sfc, r as resolveComponent, o as openBlock, c as createElementBlock, a as createBaseVNode, b as createTextVNode, d as createVNode, e as createStaticVNode } from "./app-b67551a6.js";
const _sfc_main = {};
...
const _hoisted_5 = /* @__PURE__ */ createStaticVNode('<h2 id="_2-casaos-appstore-play" tabindex="-1"><a class="header-anchor" href="#_2-casaos-appstore-play" aria-hidden="true">#</a> 2. CasaOS-AppStore-Play</h2><p>A not-so-serious CasaOS App Store.<br> Source link:</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>https://github.com/Cp0204/CasaOS-AppStore-Play/archive/refs/heads/main.zip\n</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>', 3);
const _hoisted_8 = {
